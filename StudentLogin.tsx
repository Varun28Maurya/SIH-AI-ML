    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-200">
      ...
      >
        ...
        <label className="block mb-4 text-gray-700 font-medium">
          Roll Number / Registration ID / Email
          <input
            type="text"
            placeholder="Enter your ID or Email"
            className="mt-2 w-full px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400"
          />
        </label>
        ...
        <label className="block mb-6 text-gray-700 font-medium relative">
          ...
          <input
            ...
            className="mt-2 w-full px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 pr-12"
          />
          <span
